...
public class Player {
    ...
    EditEnemy editEnemy;
    public String playerimgae ="Main/photo/FishRight.gif";
    ...
    public void keyPressed(KeyEvent e){
        ...
        if(key== KeyEvent.VK_RIGHT){
            speedx=7;
            playerimgae="Main/photo/FishRight.gif";
        }
        if (key == KeyEvent.VK_LEFT){
            speedx=-7;
            playerimgae= "Main/photo/FishLeft.gif";
        }
    }
    ...
    public void colision(){
        ...
        for (int i = 0 ; i < p.size();i++){
            if(getBounds().intersects(p.get(i).getBounds())){
                ...
                playerimgae = "Main/photo/poisfish.gif";
            }
        }
    }
}
